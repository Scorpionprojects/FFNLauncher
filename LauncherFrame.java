...
public class LauncherFrame extends JFrame {
    ...
    public LauncherFrame() {
        setTitle("FinalFront Minecraft Launcher");
        setSize(620, 500);
	...
	private DowngradeDialog openDowngrade() {
		DowngradeDialog dialog = new DowngradeDialog(this, getWorkspace(), getActiveJar());
		dialog.setVisible(true);
		return dialog;
	}
    ...
    private void buildUI() {
		...
		JButton downgradeBtn = new JButton("Downgrade...");
        buttonsPanel.add(playBtn);
        buttonsPanel.add(addonsBtn);
        buttonsPanel.add(optionsBtn);
		buttonsPanel.add(downgradeBtn);
		...
		downgradeBtn.addActionListener(new ActionListener() {
			@Override
