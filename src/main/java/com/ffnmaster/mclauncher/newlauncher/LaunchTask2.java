...
package com.ffnmaster.mclauncher.newlauncher;
...
import com.ffnmaster.mclauncher.LoginSession;
import com.ffnmaster.mclauncher.LoginSession.LoginException;
import com.ffnmaster.mclauncher.LoginSession.OutdatedLauncherException;
import com.ffnmaster.mclauncher.Task;
...
import com.ffnmaster.mclauncher.update.CancelledUpdateException;
import com.ffnmaster.mclauncher.update.UpdateCache;
import com.ffnmaster.mclauncher.update.UpdateCheck;
import com.ffnmaster.mclauncher.update.UpdateException;
import com.ffnmaster.mclauncher.update.Updater;
 ...
 * @author sk89q
 */
public class LaunchTask2 extends Task {
    
    private static final Logger logger = Logger.getLogger(LaunchTask2.class.getCanonicalName());
     ...
     */
    public LaunchTask2(JFrame frame, Configuration configuration,
    ...
    public void login() throws ExecutionException {
        ...
        try {
            ...
            throw new ExecutionException("Error in verifying Mojang Certificate. Please update your launcher via auto-update or via the website");
