...
package com.ffnmaster.mclauncher.launch;
...
public class GameLauncher  {
    ...
    private GameLauncher(File baseDir, String activeJar) {
        logger.info("FFNLauncher, v" + Launcher.VERSION);
    ...
    private void setupEnvironment() throws LaunchException {
        ...
        System.setProperty("minecraft.applet.WrapperClass", "com.ffnmaster.mclauncher.launch.GameAppletContainer");
